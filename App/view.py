...
while True:
    ...
    if int(inputs[0]) == 1:
        ...
        print("Altura del arbol de areas: " + str(controller.indexHeightAreas))
        print("Elementos en el arbol de areas: " + str(controller.indexSizeAreas))
        ...
        inicial = input("Area inicial: ")
        final = input("Area final: ")
        crimes = controller.getCrimesByRangeArea(cont, inicial, final)
        print("Total de crimenes en el rango de areas: " + str(crimes))
